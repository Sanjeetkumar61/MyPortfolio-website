...
// // import heroImg from '../../assets/Hero/skv.jpeg';
...
// //   return (
// //     <section id="hero" className="relative min-h-screen w-full bg-[#030303] pt-28 pb-12 overflow-hidden flex items-center">
...
// //         >
// //           <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/5 border border-cyan-500/20 text-cyan-400 text-xs font-bold tracking-widest uppercase mb-8">
...
// //           <div className="text-xl md:text-2xl text-gray-400 font-medium mb-8 h-8">
...
// //           <p className="text-gray-500 text-lg max-w-lg mx-auto lg:mx-0 mb-10 leading-relaxed">
...
// //               className="px-8 py-4 bg-cyan-500 text-black font-black rounded-2xl flex items-center gap-2 shadow-[0_0_30px_rgba(6,182,212,0.3)] cursor-pointer"
// //             >
...
// //               whileHover={{ scale: 1.05 }}
// //               className="px-8 py-4 bg-white/5 border border-cyan-400/30 text-white font-black rounded-2xl flex items-center gap-2 hover:bg-cyan-400/10 hover:border-cyan-400/60 transition-all duration-300 shadow-[0_0_20px_rgba(6,182,212,0.2)] cursor-pointer"
// //             >
...
// //               <a key={i} href={item.link} className={`text-gray-500 text-2xl transition-all duration-300 ${item.color}`}>
// //                 <item.icon />
// //               </a>
// //             ))}
// //           </div>
...
// //             {/* Rotating Outer Rings - Perfectly Centered */}
// //             <div className="absolute inset-0 border border-cyan-500/20 rounded-full animate-[spin_15s_linear_infinite]" />
// //             <div className="absolute inset-4 border border-dashed border-purple-500/20 rounded-full animate-[spin_20s_linear_infinite_reverse]" />
            
// //             {/* Orbiting Skill Tags */}
// //             <SkillTag name="React" color="bg-cyan-500" pos="top-10 -right-5" delay={0} />
// //             <SkillTag name="Node.js" color="bg-green-500" pos="bottom-20 -left-10" delay={1} />
// //             <SkillTag name="Express" color="bg-gray-400" pos="top-1/2 -left-16" delay={1.5} />
// //             <SkillTag name="Next.js" color="bg-gray-700" pos="-bottom-8 -right-12" delay={2} />
// //             <SkillTag name="TypeScript" color="bg-blue-500" pos="top-1/3 -right-20" delay={2.5} />

// //             {/* Profile Image - The Aspect Ratio Fix */}
// //             <div className="relative z-10 w-full h-full p-6">
// //               <div className="w-full h-full rounded-full overflow-hidden border-[6px] border-white/5 shadow-2xl relative group">
// //                 <img 
// //                   src={heroImg} 
// //                   alt="Sanjeet Kumar" 
// //                   className="w-full h-full object-cover object-top scale-120 group-hover:scale-125 transition-transform duration-700"
// //                 />
...
// //               <div className="absolute inset-6 rounded-full shadow-[0_0_60px_rgba(6,182,212,0.3)] pointer-events-none animate-pulse" />
// //             </div>

// //             {/* Background Blob */}
// //             <div className="absolute w-[80%] h-[80%] bg-cyan-500/20 blur-[80px] rounded-full -z-10" />
// //           </div>
// //         </motion.div>
// //       </div>
// //     </section>
...
// //     className={`absolute z-20 ${pos} px-4 py-2 rounded-xl bg-[#0a0a0a]/80 border border-white/10 backdrop-blur-md flex items-center gap-2 shadow-xl`}
// //   >
// //     <div className={`w-2 h-2 rounded-full ${color}`} />
// //     <span className="text-white text-xs font-bold tracking-wider">{name}</span>
// //   </motion.div>
// // );
...
//         >
//           {/* Sizing adjusted: w-64 on mobile, w-80 on tablets, w-[450px] on desktop */}
...
//             <SkillTag name="Express" color="bg-gray-400" pos="top-1/2 -left-8 lg:-left-16" delay={1.5} />
//             <SkillTag name="Next.js" color="bg-gray-700" pos="-bottom-4 -right-4 lg:-bottom-8 lg:-right-12" delay={2} />
...
//           {/* Button Group - Optimized for Mobile Tap Targets */}
